...
# in 8 groups of 16 bits each. Each group is written as 4 hexadecimal digits and 
# the groups are separated by colons (:). The address 2001:0db8:0000:0000:0000:ff00:0042:8329 
# is an example of this representation. Consecutive sections of zeros will be left as they are.
# 
# Input Format 
# An integer N such that N <= 50. This is followed by N lines such that each the text in each line is
