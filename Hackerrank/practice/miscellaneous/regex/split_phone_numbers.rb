...
# 
# This problem can be solved in many ways, however, try to solve it using regular expressions 
# and groups in order to gain a hands on practice of the concepts involved.
# 
# Sample Input
# 2
# 1 877 2638277
